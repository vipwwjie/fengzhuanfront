<template>
  <div class="app-container">
      ...
      <div class="opera-look">
          <el-form :inline="true" label-position="right">
              ...
              <el-form-item>
               ...
               <el-form-item>
                 <el-button type="primary"   @click="lookConfig" class="bgc-btm">验群配置</el-button>
              </el-form-item>
               <el-form-item>
    ...
    <el-dialog
      ...
      <div class="create-content">
        <div class="text-ti">
          <p>机器人「今日验群」数量等于此限制将在今天停止工作，第二天会恢复</p> 
        </div>
...
<script>
import { getMachineList, machineImport,PutQueryConfig, queryConfig, heatbeat, machineRelogin, machinRemove } from '@/api/index'
